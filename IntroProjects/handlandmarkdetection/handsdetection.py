...
#distance between two points p1=x,y
...
if __name__ == '__main__':
    ...
    with mp_hands.Hands(
        ...
        while cap.isOpened():
            ...
            cv2.putText(image, fingers.__str__(), (10,450), cv2.FONT_HERSHEY_COMPLEX, 1, (0, 255, 0), 2)
            cv2.putText(image, str(sum(fingers)), (10,150), cv2.FONT_HERSHEY_COMPLEX, 3, (0, 255, 0), 2)
